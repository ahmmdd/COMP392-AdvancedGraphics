...
var game = (function () {
    ...
    function init() {
        ...
        points = 0;
        lives = 10;
        document.body.style.backgroundImage = "../../Assets/images/rocks.jpg";
    ...
    function setupScoreboard() {
        ...
        lives = 5;
        // Add Lives Label
        livesLabel = new createjs.Text("LIVES: " + lives, "40px Consolas", "#000000");
        livesLabel.x = config.Screen.WIDTH * 0.1;
        livesLabel.y = (config.Screen.HEIGHT * 0.15) * 0.20;
        stage.addChild(livesLabel);
        console.log("Added Lives Label to stage");
        // Add Score Label
        scoreLabel = new createjs.Text("SCORE: " + points, "40px Consolas", "#000000");
        scoreLabel.x = 500 * 0.8;
        scoreLabel.y = (500 * 0.15) * 0.20;
