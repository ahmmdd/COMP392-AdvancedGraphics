...
(function (scenes) {
    ...
    var Play = (function (_super) {
        ...
        Play.prototype.createPickups = function () {
        ...
        Play.prototype.initializeEnemies = function () {
        ...
        Play.prototype.spawnEnemies2 = function () {
         ...
         *
         */
        Play.prototype.newCheckpoint = function () {
            this.spawnEnemies2();
            this.createPickups();
        };
        /**
         ...
         * @Method
         */
        Play.prototype.deathCheck = function () {
            if (this.player.position.y <= -5) {
        ...
        Play.prototype.endState = function () {
            if (this.player.position.z >= 100) {
                ...
                currentScene = config.Scene.PLAYTWO;
                changeScene();
            }
        };
        /**
