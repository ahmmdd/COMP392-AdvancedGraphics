...
(function (scenes) {
    ...
    var Play2 = (function (_super) {
        ...
        Play2.prototype.setupScoreboard = function () {
            ...
            //this.scoreValue = Play1.scoreValue;
            //this.livesValue = 100;
         ...
         */
        Play2.prototype.addSpotlightNext = function () {
         ...
         */
        Play2.prototype.initializeFirstGround = function () {
            this.groundTexture = new THREE.TextureLoader().load('../../Assets/images/road-seamless.jpg');
            this.groundTexture.wrapS = THREE.RepeatWrapping;
            this.groundTexture.wrapT = THREE.RepeatWrapping;
            this.groundTexture.repeat.set(8, 8);
         ...
         */
        Play2.prototype.initializeSecondGround = function () {
         ...
         */
        Play2.prototype.createPickups = function () {
        ...
        Play2.prototype.initializeEnemies = function () {
        ...
        Play2.prototype.spawnEnemies = function () {
            var max = this.nextGroundZPosition;
            var min = this.nextGroundZPosition - 15;
         ...
         *
         */
        Play2.prototype.createNewGround = function () {
         ...
         * @Method
         */
        Play2.prototype.deathCheck = function () {
            if (this.player.position.y <= -5) {
        ...
        Play2.prototype.playerPositionCheck = function () {
